...
public class FarmerRequirement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmer_requirement);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(act.getText().toString().length()!=0) {
                    Intent intent = new Intent(FarmerRequirement.this, FarmerListDisplay.class);
