...
public class MyAdapter1 extends ArrayAdapter<Ccommodity> {
    private Activity context;
    private List<Ccommodity> ccommodityList;
    public MyAdapter1(Activity context,List<Ccommodity> commodity1)
    {
        super(context,R.layout.cardview,commodity1);
        this.context=context;
        ccommodityList=commodity1;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Ccommodity commodity=ccommodityList.get(position);
